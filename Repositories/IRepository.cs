...
{
    public interface IRepository<TEntidade> : IQueryableRepository<TEntidade> where TEntidade : class, IEntidadeBase
    {
        ...
        IQueryable<TReturn> Listar<TOutput, TReturn>(ICriteria<TEntidade, TOutput> criterio,
        ...
        TReturn Selecionar<TOutput, TReturn>(ICriteria<TEntidade, TOutput> criterio,
            Expression<Func<TOutput, TReturn>> output);
    }
}